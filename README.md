...
The home page game catalog can be filtered by one or more categories and by publisher. Filters are submitted as URL query parameters, so combined results can be bookmarked or shared.
...
Coding conventions for comments, TSDoc/JSDoc, Astro component props, and TypeScript formatting
are documented in the [repository coding standards](.github/copilot-instructions.md) and the
technology-specific [instruction files](.github/instructions/).
